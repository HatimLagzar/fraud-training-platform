        ...
        <form action="{{ route('admin.posts.update', ['post' => $post]) }}" method="POST" enctype="multipart/form-data">
            ...
            <div class="form-group mb-3">
                ...
                <textarea id="editor_en"
                          name="description"
                          class="form-control"
                          placeholder="Place your post here">{{ $post->getContentEN() }}</textarea>
            </div>
            ...
            <div class="form-group mb-3">
                ...
                <textarea id="editor_fr"
                          name="description_fr"
                          class="form-control"
                          placeholder="Place your post here">{{ $post->getContentFR() }}</textarea>
            </div>
            ...
            <div class="form-group mb-3">
                ...
                <textarea id="editor_es"
                          name="description_es"
                          class="form-control"
                          placeholder="Place your post here">{{ $post->getContentES() }}</textarea>
            </div>
            ...
            <div class="form-group mb-3">
                ...
                <textarea id="editor_it"
                          name="description_it"
                          class="form-control"
                          placeholder="Place your post here">{{ $post->getContentIT() }}</textarea>
            </div>
            ...
            <div class="form-group mb-3">
                ...
                <textarea id="editor_de"
                          name="description_de"
                          class="form-control"
                          placeholder="Place your post here">{{ $post->getContentDE() }}</textarea>
            </div>
            ...
            <div class="form-group mb-3">
                ...
                <select name="country_id" id="country" class="form-select">
                    ...
                    @foreach($countries as $country)
                        <option
                                value="{{ $country->getId() }}"
                                {{ $country->getId() === $post->getCountryId() ? 'selected' : '' }}
                        >
                            {{ $country->getNiceName() }}
                        </option>
                    @endforeach
